...
import video1 from '../assets/videos/play2.mp4';
import video2 from '../assets/videos/play2.webm';
            ...
            <div className="relative h-full ml-auto lg:w-6/12">
                <div className="m-auto py-12 px-6 sm:p-20 xl:w-10/12">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="font-medium text-lg text-gray-600">Change Password</p>
                    </div>
                    ...
                    <div role="hidden" className="mt-12 border-t">
                        <span className="block w-max mx-auto -mt-3 px-4 text-center text-gray-500 bg-white">Create New Password</span>
                    </div>
                    ...
                    <form className="space-y-6 py-6" onSubmit={formik.handleSubmit}>
                        ...
                        <div>
                            <button className="w-full px-6 py-3 rounded-xl bg-sky-500 transition hover:bg-sky-600 focus:bg-sky-600 active:bg-sky-800" type='submit'>
                                <span className="font-semibold text-white text-lg">Reset</span>
                            </button>
